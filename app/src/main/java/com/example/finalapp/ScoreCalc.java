...
public class ScoreCalc {
    ...
    public int[] calculateTest(String sex, String grade, int height1, float weight1, int capacity, int jump, float reach, float shortrun, float longrun, int up) {
        ...
        int[] results = {BMIScore, BMIScore, capacityScore, jumpScore, reachScore, shortrunScore, longrunScore, pullupsitupScore, additionScore};
        return  results;
    }
}
